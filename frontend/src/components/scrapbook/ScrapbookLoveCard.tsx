...
export const ScrapbookLoveCard: React.FC<ScrapbookLoveCardProps> = ({
  ...
  return (
    <div
      ...
      className={`relative w-full transition-all duration-300 ${isOpen ? 'col-span-1 sm:col-span-2 lg:col-span-2 z-30' : 'col-span-1 z-10'
        }`}
    >
      ...
      <motion.div
        ...
        className={`relative overflow-hidden rounded-3xl cursor-pointer transition-all duration-300 border glass-card-luxury bg-slate-900/80 border-white/15 hover:border-white/30 shadow-xl ${style.borderHover}`}
      >
